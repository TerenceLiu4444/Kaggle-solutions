...
__C.DATASETS.RECOGNITION.ROOT_DIR = osp.join(__C.ROOT_DIR, '../')
__C.DATASETS.RECOGNITION.TRAIN_DIR = osp.join(__C.DATASETS.RECOGNITION.ROOT_DIR, 'input/train_224_resnet_by_class')   # run prepare_datasets.py to generate
__C.DATASETS.RECOGNITION.TEST_DIR = osp.join(__C.DATASETS.RECOGNITION.ROOT_DIR, 'input/test_resnet')     # run prepare_datasets.py to generate
